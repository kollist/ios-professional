...
//  Bankey
//
//  Created by Zaytech Mac on 28/4/2025.
//
...
//        let rotationAngle = Double.pi / 8
//        animation.keyPath = "transform.rotation"
//        animation.values = [rotationAngle, 0, -rotationAngle, 0, rotationAngle, 0]
//        animation.keyTimes = [0, 0.20, 0.40, 0.60, 0.80, 1]
//        animation.duration = 0.3
//        animation.isAdditive = true
//        
//        imageView.layer.add(animation, forKey: "wobble")
        
        shakeWith(duration: 1.0, angle: Double.pi/8, yOffset: 0.0)
    }
